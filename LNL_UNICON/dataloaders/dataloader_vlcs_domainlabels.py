...
class dg_VLCS_domainlabel_dataset(Dataset):
    def __init__(
        self, sample_ratio,
        root,
        transform,
...
class dg_VLCS_domainlabel_dataloader:
    def __init__(
        self,
        root,
        batch_size,
    ...
    def run(self, sample_r, mode,  pred=[], prob=[], paths=[]):
        if mode == "warmup":
            warmup_dataset = dg_VLCS_domainlabel_dataset(sample_r,
                self.root,
            ...
            labeled_dataset = dg_VLCS_domainlabel_dataset( sample_r,
                self.root, 
            ...
            unlabeled_dataset = dg_VLCS_domainlabel_dataset(sample_r,
                self.root, 
            ...
            eval_dataset = dg_VLCS_domainlabel_dataset( sample_r,
                self.root, 
            ...
            test_dataset = dg_VLCS_domainlabel_dataset(
            ...
            val_dataset = dg_VLCS_domainlabel_dataset(
