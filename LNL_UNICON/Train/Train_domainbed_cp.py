...
parser.add_argument("--use_domainlabels", action='store_true')
...
loader = dataloader.dg_CP_dataloader(root=args.data_path, batch_size=args.batch_size, warmup_batch_size = args.batch_size*2, num_workers=5, test_domain=args.test_domain[0], train_domain=args.train_domain, save_file=args.save_data_file_name, use_domainlabels=args.use_domainlabels)
print('| Building Net')
