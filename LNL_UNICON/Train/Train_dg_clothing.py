...
parser.add_argument('--data_path', default='/net/ivcfs5/mnt/data/swang/research/baseline_fine/FINE_official-master/dynamic_selection/dir_to_data/clothing1m', type=str, help='path to dataset')
