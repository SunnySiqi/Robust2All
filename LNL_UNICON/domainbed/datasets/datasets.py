...
class Clothing(MultipleDomainDataset):
    ...
    def __init__(self, root):
        super().__init__()
        #self.environments = ['fashion-MNIST', 'clothing1M_noisy', 'clothing1M_clean']
        self.environments = ['fashion-MNIST', 'clothing1M_noisy']
        clothing1M_noisy = clothing_dataset('../../baseline_fine/FINE_official-master/dynamic_selection/dir_to_data/clothing1m/', noisy=True)
        clothing1M_clean = clothing_dataset('../../baseline_fine/FINE_official-master/dynamic_selection/dir_to_data/clothing1m/', noisy=False)
        fashion_MNIST = fashionMNIST_dataset('../../Dataset/fashion-mnist')
        #self.datasets = [fashion_MNIST, clothing1M_noisy, clothing1M_clean]
