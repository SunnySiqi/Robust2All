...
def main():
    ...
    parser.add_argument("--add_noise", action="store_true", help="Add synthesized noise")
    parser.add_argument("--noise_ratio", type=float, help="Synthesized noise ratio")
    parser.add_argument("--noise_type", type=str, help="Synthesized noise type")
